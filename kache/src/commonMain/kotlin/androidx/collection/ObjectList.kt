 ...
 */
internal fun <E> emptyObjectList(): ObjectList<E> = EmptyObjectList as ObjectList<E>

/**
 * @return a read-only [ObjectList] with nothing in it.
 */
internal fun <E> objectListOf(): ObjectList<E> = EmptyObjectList as ObjectList<E>

/**
 * @return a new read-only [ObjectList] with [element1] as the only element in the list.
 */
internal fun <E> objectListOf(element1: E): ObjectList<E> = mutableObjectListOf(element1)

/**
 * @return a new read-only [ObjectList] with 2 elements, [element1] and [element2], in order.
 */
internal fun <E> objectListOf(element1: E, element2: E): ObjectList<E> =
 ...
 * in order.
 */
internal fun <E> objectListOf(element1: E, element2: E, element3: E): ObjectList<E> =
    mutableObjectListOf(element1, element2, element3)

/**
 * @return a new read-only [ObjectList] with [elements] in order.
 */
internal fun <E> objectListOf(vararg elements: E): ObjectList<E> =
 ...
 */
internal inline fun <E> mutableObjectListOf(): MutableObjectList<E> = MutableObjectList()

/**
 * @return a new [MutableObjectList] with [element1] as the only element in the list.
 */
internal fun <E> mutableObjectListOf(element1: E): MutableObjectList<E> {
 ...
 */
internal fun <E> mutableObjectListOf(element1: E, element2: E): MutableObjectList<E> {
 ...
 * in order.
 */
internal fun <E> mutableObjectListOf(element1: E, element2: E, element3: E): MutableObjectList<E> {
 ...
 */
internal inline fun <E> mutableObjectListOf(vararg elements: E): MutableObjectList<E> =
    MutableObjectList<E>(elements.size).apply { plusAssign(elements as Array<E>) }
