...
// Copied from kotlin.collections.AbstractMap with minor changes
internal abstract class AbstractMap<K, out V> protected constructor() : Map<K, V> {
    ...
    override fun toString(): String = entries.joinToString(", ", "{", "}") { entriesToString(it) }

    private fun entriesToString(entry: Map.Entry<K, V>): String = anyToString(entry.key) + "=" + anyToString(entry.value)

    private fun anyToString(o: Any?): String = if (o === this) "(this Map)" else o.toString()
